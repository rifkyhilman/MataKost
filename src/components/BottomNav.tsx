...
export default function BottomNav({ activeTab, setActiveTab, user }: BottomNavProps) {
  ...
  return (
    <nav className="bg-[#0A0A0A]/95 backdrop-blur-2xl docked full-width bottom-0 fixed rounded-t-2xl md:hidden z-50 border-t border-zinc-850 pb-safe shadow-[0_-8px_30px_rgba(0,0,0,0.8)]">
      <div className="flex justify-around items-center w-full px-4 py-2 min-h-[72px]">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center p-2 rounded-xl transition-all duration-300 ${
            activeTab === 'beranda'
              ? 'bg-zinc-900 text-primary scale-105 font-bold border border-zinc-800'
